...
//			Includes class implementations for the Vector class
//
// Created:
//		JL  2/18/98
// Revisions:
...
// Purpose:		Sets the current vector to equal CVector
// Arguments:	CVector 
///////////////////////////////////////////////////////////////////////////////
...
// Purpose:		Adds a CVector to the current vector
// Arguments:	CVector 
///////////////////////////////////////////////////////////////////////////////
CVector CVector::operator+( CVector arg )
{
...
// Purpose:		Subtracts a CVector from the current vector
// Arguments:	CVector 
///////////////////////////////////////////////////////////////////////////////
CVector CVector::operator-( CVector arg )
{
...
// Purpose:		Multiply a CVector by float
// Arguments:	float
///////////////////////////////////////////////////////////////////////////////
CVector CVector::operator*( float arg )
{
...
// Purpose:		Divides a CVector by float
// Arguments:	float
///////////////////////////////////////////////////////////////////////////////
CVector CVector::operator/( float arg )
{
...
// Arguments:	CVector *
///////////////////////////////////////////////////////////////////////////////
float CVector::VectorSquaredDistance(CVector *v) 
{
	return(	((x - v->x) * (x - v->x)) + 
			((y - v->y) * (y - v->y)) + 	
			((z - v->z) * (z - v->z)) ); 	
...
// Arguments:	CVector *
///////////////////////////////////////////////////////////////////////////////
float CVector::VectorDistance(CVector *v) 
{
...
///////////////////////////////////////////////////////////////////////////////
void CVector::Lerp(CVector *v1, float factor) 
{
...
///////////////////////////////////////////////////////////////////////////////
float CVector::Dot(float vx, float vy, float vz)
{
...
//				This is one obvious place for optimization perhaps asm code
///////////////////////////////////////////////////////////////////////////////
void CVector::MultVectorByMatrix(float *mat)
{
	CVector result;
	result.x = (mat[0] * x) +
			   (mat[4] * y) +	
...
//				This is one obvious place for optimization perhaps asm code
///////////////////////////////////////////////////////////////////////////////
void CVector::MultVectorByRotMatrix(float *mat)
{
	CVector result;
	result.x = (mat[0] * x) +
			   (mat[4] * y) +	
