...
#include "exceptionhandler.h" // For CrashTestFunction()
...
BOOL CMfctestDlg::OnInitDialog()
{
	...
	SetDlgItemText(IDC_DESCRIPTION,
				"Click on one of buttons to cause this program to crash. "
				"Information about the crash will be written to the file "
				"'errorlog.txt' in the executable's directory.");
...
void CMfctestDlg::OnCrash( UINT nID )
{
	int CrashCode = nID - IDC_ERROR0;
