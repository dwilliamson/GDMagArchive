...
struct Parser {
    ...
    Atom *make_atom(Text_Utf8 *name);
    Variable *make_variable(Text_Utf8 *name);
    Integer *make_integer(int value);
    Float *make_float(double value);
    String *make_string(Text_Utf8 *value);
    Ast *make_implicit_variable(int value);
