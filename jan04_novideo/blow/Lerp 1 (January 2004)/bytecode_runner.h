...
struct Lerp_Bytecode_Runner {
    ...
    Barrier <Lerp_Call_Record *> *current_context;
    void run(Procedure *procedure);  // Assumes no arguments...
    void run(Lerp_Bytecode *bytecode);

    void write_register(int register_index, First_Class *value);
