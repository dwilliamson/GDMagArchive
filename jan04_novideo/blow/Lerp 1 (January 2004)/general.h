...
struct Database : public First_Class {
    ...
    void add_assertion(Lerp_Interp *interp, Decl_Expression *expression);
    void add_assertion(Lerp_Interp *interp, First_Class *arg1, First_Class *arg2);
    void add_assertion(Lerp_Interp *interp, First_Class *arg1, First_Class *arg2, First_Class *arg3);

    void assign_named_slot(Lerp_Interp *, Atom *name, Barrier <First_Class *> *value);
    void assign_named_slot(Lerp_Interp *, Atom *name, First_Class *value);
    First_Class *lookup_named_slot(Lerp_Interp *, Atom *name);
