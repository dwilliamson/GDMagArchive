...
void appDraw()
{
  ...
  // Quick hack for aesthetics: make the camera at least 4 units above the terrain.
  if (terrain.contains(GlobalCamera::Instance()->getPosition().x, GlobalCamera::Instance()->getPosition().y))
  {
