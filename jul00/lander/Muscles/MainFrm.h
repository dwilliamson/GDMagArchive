...
protected:
	...
	afx_msg void OnViewShowmuscles();
	afx_msg void OnUpdateViewShowmuscles(CCmdUI* pCmdUI);
	afx_msg void OnSimulationUsemuscles();
	afx_msg void OnUpdateSimulationUsemuscles(CCmdUI* pCmdUI);
	afx_msg void OnSimulationSpringmusclesettings();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
