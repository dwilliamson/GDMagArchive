...
//
// Purpose:	Implementation of OpenGL Window of Muscles Demonstration
//
// Created:
//		JL 11/20/98		
...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWnd)
	...
	ON_COMMAND(ID_VIEW_SHOWMUSCLES, OnViewShowmuscles)
	ON_UPDATE_COMMAND_UI(ID_VIEW_SHOWMUSCLES, OnUpdateViewShowmuscles)
	ON_COMMAND(ID_SIMULATION_USEMUSCLES, OnSimulationUsemuscles)
	ON_UPDATE_COMMAND_UI(ID_SIMULATION_USEMUSCLES, OnUpdateSimulationUsemuscles)
	ON_COMMAND(ID_SIMULATION_SPRINGMUSCLESETTINGS, OnSimulationSpringmusclesettings)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
//	m_OGLView.LoadFile("dolphin.dps","dolphin","dps");
...
// Turn on/off the muscle flexing
void CMainFrame::OnSimulationUsemuscles() 
{
	m_OGLView.m_PhysEnv.m_MusclesFlexin = !m_OGLView.m_PhysEnv.m_MusclesFlexin;
	m_OGLView.Invalidate(TRUE);
}

void CMainFrame::OnUpdateSimulationUsemuscles(CCmdUI* pCmdUI) 
{
	pCmdUI->SetCheck( m_OGLView.m_PhysEnv.m_MusclesFlexin );
}

// Edit selected Spring/Muscle
void CMainFrame::OnSimulationSpringmusclesettings() 
{
	m_OGLView.m_PhysEnv.EditMuscle();
}
...
void CMainFrame::OnViewShowmuscles() 
{
	m_OGLView.m_PhysEnv.m_DrawMuscles = !m_OGLView.m_PhysEnv.m_DrawMuscles;
	m_OGLView.Invalidate(TRUE);
}

void CMainFrame::OnUpdateViewShowmuscles(CCmdUI* pCmdUI) 
{
	pCmdUI->SetCheck( m_OGLView.m_PhysEnv.m_DrawMuscles );
}
