...
{
	m_OGLView.CylinderMapModel(0.14f, 0.0f);
	m_OGLView.FixupMapCoords();
	m_OGLView.drawScene();	
}
...
{
	m_OGLView.PlanarMapModel(YZ_PLANE,0.2f, 0.0f, 0.2f, 0.0f);
	m_OGLView.FixupMapCoords();
	m_OGLView.drawScene();	
}
...
{
	m_OGLView.PlanarMapModel(XZ_PLANE,0.2f, 0.0f, 0.2f, 0.0f);
	m_OGLView.FixupMapCoords();
	m_OGLView.drawScene();	
}
...
{
	m_OGLView.PlanarMapModel(XY_PLANE,0.2f, 0.0f, 0.2f, 0.0f);
	m_OGLView.FixupMapCoords();
	m_OGLView.drawScene();	
}
